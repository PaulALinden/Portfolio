...
export default function Footer() {
    return (
        <footer id="socialmedia" className="text-white order-3 flex space-x-2 bg-[#374151] w-24 border-2 border-slate-400 dark:border-white lg:fixed bottom-6 right-6 p-4">
